...
export const TamaguiLogo = ({ showWords, color }: { showWords?: boolean; color?: string }) => (
  <XStack ai="center" jc="center" space="$5">
    <LogoIcon downscale={showWords ? 2 : 1.5} color={color} />
    {showWords && (
      <YStack mb={-4}>
        <LogoWords downscale={2} color={color} />
      </YStack>
    )}
  </XStack>
)
