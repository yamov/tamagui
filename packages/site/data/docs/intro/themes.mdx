...
The `name` attribute will be removed from the defaultProps as it's special, and instructs Tamagui to look for any `_button` theme. So you can add the following themes to customize buttons at any level:
